...
internal sealed class DouYinFileSystemRequestPackageVersionOperation : FSRequestPackageVersionOperation
{
    private readonly DouYinFileSystem _fileSystem;
    private readonly int _timeout;
    private RequestDouYinPackageVersionOperation _requestWebPackageVersionOp;
    private ESteps _steps = ESteps.None;


    internal DouYinFileSystemRequestPackageVersionOperation(DouYinFileSystem fileSystem, int timeout)
    {
    ...
    internal override void InternalOnUpdate()
    {
        ...
        if (_steps == ESteps.RequestPackageVersion)
        {
            ...
            {
                _requestWebPackageVersionOp = new RequestDouYinPackageVersionOperation(_fileSystem, _timeout);
